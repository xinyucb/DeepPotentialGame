...
class FBSNN(nn.Module):  # Forward-Backward Stochastic Neural Network
    ...
    def Actor_step(self, net_actor, optimizer_actor):
        ...
        if self.random_initial_state:
            X0 +=  np.random.rand(self.M, self.state_dim * self.D)* 1
    ...
    def generate_1d_trajectory(self, X_trajectory=None, plot_mean=True, preset_sample_ind=0,plot_label="X", Title=""):
