...
class FBSNN(nn.Module):  # Forward-Backward Stochastic Neural Network
    def __init__(self, net_control, params):
        ...
        self.num_of_origin = self.params_equ["num_of_origin"]
        ...
        self.filename= f"_{self.game_type}_{self.control_type}_D{self.D}_d{self.state_dim}_dest{self.num_of_dest}_orig{num_of_orig}_{Q_type}_fiu{model2.fi_param_u}_fix{model2.fi_param_x}_gi{model2.params_equ['gi_param']}_Depth{model2.params_net['depth']}"
